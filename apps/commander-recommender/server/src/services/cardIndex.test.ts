/**
 * Tests for the cited-card index.
 *
...
describe('createCardIndex', () => {
  it('the same card cited twice is stored once', () => {
  ...
  it('different cards get different positions', () => {
    const index = createCardIndex();
  ...
  it('positions resolve back to the card that was cited', () => {
  ...
  it('a card citation keeps the quantity from the list', () => {
  ...
  it('positions are stable as more cards are added', () => {
  ...
  it('an index nothing was cited into is empty, not undefined', () => {
