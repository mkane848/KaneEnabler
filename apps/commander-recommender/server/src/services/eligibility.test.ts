...
describe('isCommanderEligible', () => {
  ...
  it('a transforming land with a legendary creature back is NOT eligible', () => {
      ...
      card_faces: [
        {
          ...
          oracle_text: 'When Bushi Tenderfoot is dealt damage, flip it.',
        },
  ...
  it('a DFC with a legendary creature FRONT is eligible', () => {
      ...
      card_faces: [
        {
          ...
          oracle_text: 'Creatures you control with auras have double strike.',
        },
        {
  ...
  it('a non-legendary creature is not eligible', () => {
    const card: ScryfallCardLike = {
      layout: 'normal',
...
describe('frontFaceCharacteristics', () => {
  it('a split card keeps both halves (709.4), unlike a DFC', () => {
